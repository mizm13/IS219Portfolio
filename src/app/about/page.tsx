        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            ...
            <p className="text-xl text-neutral-700 dark:text-neutral-200">
              IT Specialist & Web Developer pushing the boundaries of system integration and automation
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white dark:bg-neutral-800">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-6 text-neutral-900 dark:text-white">My Mission</h2>
            <p className="text-xl text-neutral-700 dark:text-neutral-200">
              To build reliable, innovative systems that solve real business challenges through automation, infrastructure improvements, and collaborative development. I'm passionate about learning emerging technologies and applying practical solutions to complex problems.
            </p>
          </div>
        </div>
      </section>
